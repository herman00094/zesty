...
public final class Zesty {
    ...
    private int zestProbe104(int a, int b) {
        int x = (a ^ b) + 104;
        int y = (a & b) | (104 << 1);
        return Integer.rotateLeft(x, 3) ^ Integer.rotateRight(y, 2);
    }

    private int zestProbe105(int a, int b) {
        int x = (a ^ b) + 105;
        int y = (a & b) | (105 << 1);
        return Integer.rotateLeft(x, 3) ^ Integer.rotateRight(y, 2);
    }

    private int zestProbe106(int a, int b) {
        int x = (a ^ b) + 106;
        int y = (a & b) | (106 << 1);
        return Integer.rotateLeft(x, 3) ^ Integer.rotateRight(y, 2);
    }

    private int zestProbe107(int a, int b) {
        int x = (a ^ b) + 107;
        int y = (a & b) | (107 << 1);
        return Integer.rotateLeft(x, 3) ^ Integer.rotateRight(y, 2);
    }

    private int zestProbe108(int a, int b) {
        int x = (a ^ b) + 108;
        int y = (a & b) | (108 << 1);
        return Integer.rotateLeft(x, 3) ^ Integer.rotateRight(y, 2);
    }

    private int zestProbe109(int a, int b) {
        int x = (a ^ b) + 109;
        int y = (a & b) | (109 << 1);
        return Integer.rotateLeft(x, 3) ^ Integer.rotateRight(y, 2);
    }

    private int zestProbe110(int a, int b) {
        int x = (a ^ b) + 110;
        int y = (a & b) | (110 << 1);
        return Integer.rotateLeft(x, 3) ^ Integer.rotateRight(y, 2);
    }

    private int zestProbe111(int a, int b) {
        int x = (a ^ b) + 111;
        int y = (a & b) | (111 << 1);
        return Integer.rotateLeft(x, 3) ^ Integer.rotateRight(y, 2);
    }

    private int zestProbe112(int a, int b) {
        int x = (a ^ b) + 112;
        int y = (a & b) | (112 << 1);
        return Integer.rotateLeft(x, 3) ^ Integer.rotateRight(y, 2);
    }

    private int zestProbe113(int a, int b) {
        int x = (a ^ b) + 113;
        int y = (a & b) | (113 << 1);
        return Integer.rotateLeft(x, 3) ^ Integer.rotateRight(y, 2);
    }
    ...
    public int aggregateProbes(int seed) {
        ...
        acc ^= zestProbe38(acc, seed + 38);
        acc ^= zestProbe39(acc, seed + 39);
        acc ^= zestProbe40(acc, seed + 40);
        acc ^= zestProbe41(acc, seed + 41);
        acc ^= zestProbe42(acc, seed + 42);
        acc ^= zestProbe43(acc, seed + 43);
        acc ^= zestProbe44(acc, seed + 44);
        acc ^= zestProbe45(acc, seed + 45);
        acc ^= zestProbe46(acc, seed + 46);
        acc ^= zestProbe47(acc, seed + 47);
        acc ^= zestProbe48(acc, seed + 48);
        acc ^= zestProbe49(acc, seed + 49);
        acc ^= zestProbe50(acc, seed + 50);
        acc ^= zestProbe51(acc, seed + 51);
        acc ^= zestProbe52(acc, seed + 52);
        acc ^= zestProbe53(acc, seed + 53);
        acc ^= zestProbe54(acc, seed + 54);
        acc ^= zestProbe55(acc, seed + 55);
        acc ^= zestProbe56(acc, seed + 56);
        acc ^= zestProbe57(acc, seed + 57);
        acc ^= zestProbe58(acc, seed + 58);
        acc ^= zestProbe59(acc, seed + 59);
        acc ^= zestProbe60(acc, seed + 60);
        acc ^= zestProbe61(acc, seed + 61);
        acc ^= zestProbe62(acc, seed + 62);
        acc ^= zestProbe63(acc, seed + 63);
        acc ^= zestProbe64(acc, seed + 64);
        acc ^= zestProbe65(acc, seed + 65);
        acc ^= zestProbe66(acc, seed + 66);
        acc ^= zestProbe67(acc, seed + 67);
        acc ^= zestProbe68(acc, seed + 68);
        acc ^= zestProbe69(acc, seed + 69);
        acc ^= zestProbe70(acc, seed + 70);
        acc ^= zestProbe71(acc, seed + 71);
        acc ^= zestProbe72(acc, seed + 72);
        acc ^= zestProbe73(acc, seed + 73);
        acc ^= zestProbe74(acc, seed + 74);
        acc ^= zestProbe75(acc, seed + 75);
        acc ^= zestProbe76(acc, seed + 76);
        acc ^= zestProbe77(acc, seed + 77);
        acc ^= zestProbe78(acc, seed + 78);
        acc ^= zestProbe79(acc, seed + 79);
        acc ^= zestProbe80(acc, seed + 80);
        acc ^= zestProbe81(acc, seed + 81);
        acc ^= zestProbe82(acc, seed + 82);
        acc ^= zestProbe83(acc, seed + 83);
        acc ^= zestProbe84(acc, seed + 84);
        acc ^= zestProbe85(acc, seed + 85);
        acc ^= zestProbe86(acc, seed + 86);
        acc ^= zestProbe87(acc, seed + 87);
        acc ^= zestProbe88(acc, seed + 88);
        acc ^= zestProbe89(acc, seed + 89);
        acc ^= zestProbe90(acc, seed + 90);
        acc ^= zestProbe91(acc, seed + 91);
        acc ^= zestProbe92(acc, seed + 92);
        acc ^= zestProbe93(acc, seed + 93);
        acc ^= zestProbe94(acc, seed + 94);
        acc ^= zestProbe95(acc, seed + 95);
        acc ^= zestProbe96(acc, seed + 96);
